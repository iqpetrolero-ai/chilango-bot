    ...
    try:
        ...
        if agotados:
            agotados_ctx = (
                ...
                f"\n0. VERIFICACIÓN OBLIGATORIA ANTES DE OFRECER: Antes de mencionar, sugerir, preguntar"
                f"\n   o listar CUALQUIER producto como opción (add-on, alternativa, pregunta de elección),"
                f"\n   verifica que NO esté en la lista de agotados. Si está agotado, NO lo menciones"
                f"\n   como opción disponible."
                f"\n   ⚠️ CRÍTICO — DOBLE VERIFICACIÓN EN ALTERNATIVAS: Cuando sugieras una alternativa a un"
                f"\n   producto agotado, verifica PRIMERO que esa alternativa tampoco esté agotada ni use"
                f"\n   ingredientes agotados. Nunca ofrezcas como alternativa un producto que también está agotado."
                f"\n   Ejemplo: si Pastor Y Chorizo están agotados y el cliente pide Campechano,"
                f"\n   NO ofrezcas Taco de Pastor ni Choriqueso — ambos también están agotados."
                f"\n1. PRODUCTOS DIRECTOS: Si el cliente pide un producto agotado, avísale y sugiere alternativa DISPONIBLE."
